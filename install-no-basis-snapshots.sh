...
npm install /github/workspace/igs/snapshots/hl7.fhir.no.basis-2.1.2-delta.tgz
...
mkdir -p /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.1.2-delta/package
ls -al /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.1.2-delta/package
echo "Copy no-basis to /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.1.2-beta/package"
cp -r /github/workspace/node_modules/hl7.fhir.no.basis/* /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.1.2-delta/package
ls -al /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.1.2-delta/package
