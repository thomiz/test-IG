...
echo "NPM install fhir no-basis220alpha from local tgz"
npm install /github/workspace/igs/snapshots/hl7.fhir.no.basis-2.2.0-alpha.tgz
...
mkdir -p /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.2.0-alpha/package
ls -al /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.2.0-alpha/package
echo "Copy no-basis to /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.2.0-alpha/package"
cp -r /github/workspace/node_modules/hl7.fhir.no.basis/* /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.2.0-alpha/package
ls -al /home/publisher/.fhir/packages/hl7.fhir.no.basis#2.2.0-alpha/package
